...
$.extend({
	...
	album_post: function(FRM){
		...
		$.ajax({
		    type: "POST",
		    url: "<?php echo site_url('players/updategallery');?>",
		    data: data,
		    dataType: "json",
		    beforeSend: function(){
		        //console.log(data);
...
<div id='content_header'>
	<div class='hdr-text'><?php  echo $u_details->first_name; ?> <?php  echo $u_details->last_name; ?> Edit Gallery</div>
</div>

<div id='content_wrapper' class="pad">
<?php if(isset($rows) and $rows!='') {
		 ?>
<form id="appl_form" method="post" enctype="multipart/form-data" action="<?php echo site_url('players/updategallery');?>" name="appl_form">
    ...
    <ul class='wesp-form'>
		...
		<li>
            <label for="description">Description</label>
           	<textarea name="description" class="" id="description"><?php echo $rows->description;?></textarea>
        </li>
