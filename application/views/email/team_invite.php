...
<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-size:12px;font-family: Helvetica,Arial, sans-serif;min-width:320px; width: 100%;">
		<tr><td colspan="3" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #dedede;"></td></tr>
    	 <tr style='height: 45px; background: #f0f2f5;'>
            <td align="left" style="padding: 19px 0 13px 12px;"><span style='color:#686a6e;font-size:18px;font-weight:bold;font-family:Helvetica,Arial, sans-serif;'> <?='Join our team '.ucwords($t_details->name).' on WESport'?></span></td>
         ...
         <tr style='height: 52px;'>
         	<td colspan="3" style="padding: 23px 10px 13px 12px;"><span style='color:#454545;font-size:13px;font-family:Helvetica,Arial,sans-serif;'>
			<img class="impfn" src="<?php echo base_url(); ?><?php if($t_details->logo!='') echo 'images/teams/th_'.$t_details->logo;else echo "css/images/no_image.jpg";?>" height="100" width="100" /> <?=ucwords($t_details->first_name.' '.$t_details->last_name)?>  wants to Invite you join <?=ucwords($t_details->name)?> on WESport.
			<br />
			 <a href="<?php echo site_url('invitation');?>" target="_blank" style="text-decoration:none;color:#005ac9;font-size:14px;font-family: Helvetica,Arial, sans-serif;">Accept</a> or <a href="<?php echo site_url('invitation');?>" target="_blank" style="text-decoration:none;color:#005ac9;font-size:14px;font-family: Helvetica,Arial, sans-serif;">Decline</a></span></td>
            <td></td>
         </tr>
