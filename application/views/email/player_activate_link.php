...
<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-size:12px;font-family: Helvetica,Arial, sans-serif;min-width:320px; width: 100%;">
		<tr><td colspan="3" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #dedede;"></td></tr>
    	 <tr style='height: 45px; background: #f0f2f5;'>
            <td align="left" style="padding: 19px 0 13px 12px;"><span style='color:#686a6e;font-size:18px;font-weight:bold;font-family:Helvetica,Arial, sans-serif;'> Congratulations on registering</span></td>
         ...
         <tr style='height: 52px;'>
         	<td colspan="3" style="padding: 23px 10px 13px 12px;"><span style='color:#454545;font-size:13px;font-family:Helvetica,Arial,sans-serif;'>Please confirm your email address in order to login to WESport. 
                                                <br/>
                                                <br/>
                                                Click this activation link or copy and paste it in your browser's address bar:<br/>
                                                <a href="<?=site_url('activate/'.$id.'/'.$activation_code)?>" style="color:#2b79b0;text-decoration:none; padding: 4px;"><?=site_url('activate/'.$id.'/'.$activation_code)?></a></span></td>
            <td></td>
         </tr>
        
         <tr>
         	<td style="padding: 23px 10px 13px 12px;">
            	You can login to your account at <a href="<?php echo site_url('login');?>" target="_blank" style="text-decoration:none;color:#005ac9;font-size:14px;">
				<?=site_url()?></a><br />
Enjoy!
<br />
The WESport Team
