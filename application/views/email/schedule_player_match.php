...
<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-size:12px;font-family: Helvetica,Arial, sans-serif;min-width:320px; width: 100%;">
		<tr><td colspan="3" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #dedede;"></td></tr>
    	 <tr style='height: 45px; background: #f0f2f5;'>
            <td align="left" style="padding: 19px 0 13px 12px;"><span style='color:#686a6e;font-size:18px;font-weight:bold;font-family:Helvetica,Arial, sans-serif;'> </span></td>
         ...
         <tr style='height: 52px;'>
         	<td colspan="3" style="padding: 23px 10px 13px 12px;"><span style='color:#454545;font-size:13px;font-family:Helvetica,Arial,sans-serif;'><?='Match Agenda '.ucwords($this->userFname.' '.$this->userLname).' wants to play with you on '.date('m-d-Y',strtotime($sh->start_date)).' at '.date('H:i a',strtotime($sh->start_date))?> at Location on <?=$sh->location?>.<br />WESport <br /><a href="<?php echo site_url('invitation');?>" target="_blank" style="text-decoration:none;color:#005ac9;font-size:14px;font-family: Helvetica,Arial, sans-serif;">Accept</a> or <a href="<?php echo site_url('invitation');?>" target="_blank" style="text-decoration:none;color:#005ac9;font-size:14px;font-family: Helvetica,Arial, sans-serif;">Decline</a></span></td>
            <td></td>
         </tr>
