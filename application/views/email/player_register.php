...
<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-size:12px;font-family: Helvetica,Arial, sans-serif;min-width:320px; width: 100%;">
		<tr><td colspan="3" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #dedede;"></td></tr>
    	 <tr style='height: 45px; background: #f0f2f5;'>
            <td align="left" style="padding: 19px 0 13px 12px;"><span style='color:#686a6e;font-size:18px;font-weight:bold;font-family:Helvetica,Arial, sans-serif;'> Congratulations on activating WESport account</span></td>
         	...
         	<td>
            	<table align="left" style="font-family: Helvetica,Arial, sans-serif;">
                	<tr style='height: 25px;'>
                    	<td style="padding:0px 10px 10px 10px;color:#787878;font-size:14px;font-family: Helvetica,Arial, sans-serif;">Your Login id : </td>
		 ...
		 <tr style='height: 52px;'>
         	<td colspan="3" style="padding: 23px 10px 13px 12px;"><span style='color:#454545;font-size:13px;font-family:Helvetica,Arial,sans-serif;'>You can login to your account at <a href="<?php echo site_url('login');?>" target="_blank" style="text-decoration:none;color:#005ac9;font-size:14px;">
				<?=site_url()?></a><br />
Enjoy!
<br />
The WESport Team</span></td>
            <td></td>
         </tr>
