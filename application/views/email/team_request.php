...
<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-size:12px;font-family: Helvetica,Arial, sans-serif;min-width:320px; width: 100%;">
		<tr><td colspan="3" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #dedede;"></td></tr>
    	 <tr style='height: 45px; background: #f0f2f5;'>
            <td align="left" style="padding: 19px 0 13px 12px;"><span style='color:#686a6e;font-size:18px;font-weight:bold;font-family:Helvetica,Arial, sans-serif;'> <?='Request to Join '.ucwords($t_details->name).' on WESport'?></span></td>
         ...
         <tr style='height: 52px;'>
         	<td colspan="3" style="padding: 23px 10px 13px 12px;"><span style='color:#454545;font-size:13px;font-family:Helvetica,Arial,sans-serif;'><img class="impfn" src="<?php echo base_url(); ?><?php if($this->image!='') echo $this->image;else  echo $this->gender=='m'?"css/images/empty_image.png":"css/images/female_image.png";?>" height="100" width="100" /></a> <?php echo $this->userFname.' '.$this->userLname;?> wants to join <?=ucwords($t_details->name)?> on WESport.<br />
