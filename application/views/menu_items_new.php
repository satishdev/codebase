...
<div class="menu-bg">
	<div class="menu ca">
        ...
        <div class="menu_left">
			<ul>
				<li><a  <? if(@$my_select=='home'){?>class="active"<? }?>  href="<?php echo site_url('home'); ?>">Home</a></li>
				<li><a  <? if(@$my_select=='signin'){?>class="active"<? }?> href="<?php echo site_url('login'); ?>">Sign In</a></li>
			</ul>
			<div class="clr"></div>
		</div>
        ...
        <div class="item fr men_left">
            ...
            <div id="user_type_selector_options" class="sub_menu_bar small_sub_menu">
                ...
                <?php foreach($user_drop as $k=>$v){ ?>
                	...
                	<div class="item"><a  class="menu_link" onclick="check_adv(<?php echo $k?>)" rel="<?php echo $k; ?>"><?php echo $v; ?></a></div>
