...
?>
            ...
            <a href="<?=base_url()?>" class="parent"><span><?php echo $country_id?></span></a>
				...
				for($i=0;$i<$total;$i++)
				{?>
					<li><a href="<?php echo base_url()?>teetime_golfcourse/state/golfcourse/<?php echo $country_id?>/<?php echo $first[$i]->id;?>" class="parent"><span><?php echo $first[$i]->nm;?></span></a>
					<? 
					...
					{?>
						<ul>
						<li><a href="<?php echo base_url()?>teetime_golfcourse/area/golfcourse/<?php echo $country_id?>/<?php echo $first[$i]->id;?>/<?php echo $second[0]->id;?>" ><span><?php echo $second[0]->nm;?></span></a></li>
						</ul>	
					<?php
					}
					else if($total2>1)
					{	?>
						...
						for($k=0;$k<$total2;$k++)
						{ ?>
						<li><a href="<?php echo base_url()?>teetime_golfcourse/area/golfcourse/<?php echo $country_id?>/<?php echo $first[$i]->id;?>/<?php echo $second[$k]->id;?>" ><span><?php echo $second[$k]->nm;?></span></a></li>
						<?php 
						}?>
						</ul>
					<?php 
		...
		<li class="eur2">
		<a href="<?php echo base_url()?>teetime_golfcourse/state/golfcourse/<?php echo $country_id?>/<?php echo $state_id;?>" class="parent"><span><?php echo $state_id.' Golf Courses' ;?></span></a>
		...
		//{
			...
			{?>
			<li>
			<a href="<?php echo base_url()?>teetime_golfcourse/area/golfcourse/<?php echo $country_id?>/<?php echo $state_id;?>/<?php echo $first[0]->id; ?>"><span><?php echo $first[0]->nm;?></span></a></li>
		<?  }//end if record is single
			...
			if($count>1)
			{
				...
				{?>
				<li>
				<a href="<?php echo base_url()?>teetime_golfcourse/area/golfcourse/<?php echo $country_id?>/<?php echo $state_id;?>/<?php echo $first[$s]->id; ?>"><span><?php echo $first[$s]->nm;?></span></a>
					<!--work on it-->
					<!--<ul>
		...
		<? }//end state Area's listing?>
		 ...
		 <li class="eur3">
		 <a href="<?php echo base_url()?>teetime_golfcourse/area/golfcourse/<?php echo $country_id?>/<?php echo $state_id;?>/<?php echo  $area_id; ?>" class="parent"><span><?php echo  $area_id.' Golf Courses' ;?></span></a>
