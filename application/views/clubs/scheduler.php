...
<!--<link type="text/css" rel="stylesheet" media="all" href="<?php echo base_url();?>css/fullcalendar/theme.css" />-->
<link type="text/css" rel="stylesheet" media="all" href="<?php echo base_url();?>css/fullcalendar/fullcalendar.css" />
<!--<link type="text/css" rel="stylesheet" media="all" href="<?php echo base_url();?>css/fullcalendar/fullcalendar.print.css"  media='print' />-->
<!--<script type="text/javascript" src="<?php echo base_url();?>js/fullcalendar/jquery-ui-1.8.11.custom.min.js"></script>-->
...
function saveEvent(dataObj){
    test=dataObj;
    if(dataObj.title){
//        start_date=dataObj.start.getFullYear()+'-'+(parseInt(dataObj.start.getMonth())+1)+'-'+dataObj.start.getDate();
//        if(dataObj.end){
//            end_date=dataObj.end.getFullYear()+'-'+(parseInt(dataObj.end.getMonth())+1)+'-'+dataObj.end.getDate();
//        }else{
//            end_date=start_date;
//        }
        // dataP='allDay='+dataObj.allDay+'&end_date='+end_date+'&start_date='+start_date+'&description='+dataObj.title;
