...
<div id="menu_wrap">
    <div class="menu_bar">
           ...
           <li><a class="item" href="<?php echo site_url('players/profile'); ?>">Profile</a>
			...
			<li><a class="item" href="<?php echo site_url('players/friends'); ?>">Contacts</a>
            	<ul class='children'>
                    ...
                    <li><a class="item" href="<?php echo site_url('players/allplayers'); ?>">Add/Search Partners</a></li>
        ...
        <div class="menu_item fl">
            <a class="menu_link" href="<?php echo site_url('home'); ?>">Home</a>
        </div>

       <!-- <div class="menu_item fl">
            <a class="menu_link">What is WESports?</a>
        </div>-->
       <!-- <div class="menu_item fl">
            <a class="menu_link">How this Works</a>
        </div>-->

        <div class="menu_item fl">
            <a class="menu_link" href="<?php echo site_url('login'); ?>">Sign In</a>
        </div>
		<!--<div class="menu_item fl">
            <a class="menu_link">BOOK TEE TIMES</a>
        </div>
        <div class="menu_item fl">
            <a class="menu_link" href="<?php echo site_url('club_register'); ?>">Club Registration</a>
        </div>-->
        <?php } ?>
