...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>styles/fancybox/jquery.fancybox-1.3.4.css" />
...
<link href="<?php echo base_url();?>styles/fileuploader.css" rel="stylesheet" type="text/css" />
...
<link href="<?php echo base_url();?>css/notification.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url();?>css/clubs.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo base_url();?>js/views/common.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>js/jquery.jqGrid.src.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>scripts/fancybox/jquery.easing-1.3.pack.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>scripts/fancybox/jquery.fancybox-1.3.4.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>scripts/fancybox/jquery.mousewheel-3.0.4.pack.js"></script>
<link rel="stylesheet" href="<?php echo base_url();?>styles/uploadify.css" type="text/css" /></script>
<script type="text/javascript" src="<?php echo base_url();?>scripts/jquery.uploadify-3.1.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>scripts/fileuploader.js"></script>
