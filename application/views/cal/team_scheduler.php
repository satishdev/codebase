        ...
        $(document).ready(function() {     
           var view="month";          
            ...
            var op = {
                ...
                autoload:true,
                url:base_url+"teams/datafeed/<?php echo $id;?>",  
                quickAddUrl: base_url+"teams/save_event/<?php echo $id;?>", 
...
<body>-->
    <div>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            <div class="cHead"><div class="ftitle"><?php echo anchor('teams/viewteam/'.$t_details->id,$t_details->name);?> Team Calendar</div>
