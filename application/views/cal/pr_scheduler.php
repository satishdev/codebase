...
<body>-->
    <div>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            <div class="cHead"><div class="ftitle"><?php  echo anchor('profile/view/'.$id,ucwords($u_details->first_name.' '.$u_details->last_name)); ?> Calendar</div>
