...
foreach($result->result() as $row)
{
  ?>  
	...
	<a href="#." onclick="delete_cart(<?php echo $row->gama_add_cart_id?>)">[x] remove</a>
		...
		<style>
	.region4_1{margin-left:110px!important;text-align: center!important;width: 116px!important; padding-top:3px!important;}
	.second{margin-left:4px!important; width: 130px!important;}
	</style>
	
<div class="region4_1">	
<a style="color:#FFFFFF;" href="<?php echo @$url;?>">Continue Shopping</a>
</div>
