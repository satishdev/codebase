...
<div id='content_header'>
	<div class='hdr-text'><?php if($this->userType==2) echo anchor('profile/view/'.$id,ucwords($u_details->first_name.' '.$u_details->last_name)).' Teams';else echo "Teams";?></div>
    ...
    <div class="opt_box_wrapper team">
		 ...
		 $win_loss=$this->teams_model->teamschedule_win_loss_team($row->tid);?>
			...
			<div class="team_list_details"> 
				...
				<span>Captain <span class="count" title="<?php echo $row->captain; ?>"><?php echo $row->captain;?></span></span>
			</div>
