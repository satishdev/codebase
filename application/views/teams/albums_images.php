...
<div id='content_header'>
	<div class='hdr-text'><?php echo anchor('teams/gallery/'.$t_details->id,$t_details->name).' Team Album '.$info->name. ' Photos';?></div>
    <?php if($info->created_by==$this->userId){ echo smallButton(array('label'=>'Add New Image', 'href'=>site_url('teams/addgalleryimage/'.$t_details->id.'/'.$info->id))); } ?>
</div>
