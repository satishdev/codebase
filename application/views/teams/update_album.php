...
$.extend({
	...
	album_post: function(FRM){
		...
		$.ajax({
		    type: "POST",
		    url: "<?php echo site_url('teams/updategallery');?>",
		    data: data,
		    dataType: "json",
		    beforeSend: function(){
		        //console.log(data);
...
<?php if(isset($rows) and $rows!='') {
		 ?>
<form id="appl_form" method="post" enctype="multipart/form-data" action="<?php echo site_url('teams/updategallery');?>" name="appl_form">
