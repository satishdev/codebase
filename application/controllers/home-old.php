...
class Home extends CI_Controller
{
        ...
        if ($response->CourseAvailListResult->RetCd == 0) {
            ...
            if ($count > 0) {
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    $html .= '<li id="' . $i . '" style="list-style:none;"  onclick="go_text(' . $cli . ',' . $course_id . ')">' . $result[$i]->nm . '</li>';
                }
                echo '</ul></div>';
                echo $html;
            } else {
    ...
    function searchteetimes()
    {
        ...
        $serchKey = $this->input->post('serchKey');
        $course_id = $this->input->post('serchKey');
        ...
        $response = $client->CourseAvailList(array("Hdr"=>array("ResellerId"=>"WPA",
                    ...
                    if($RetCd==0)
                    {
                        ...
                        //end golfcourse name match or not.
                            ...
                            //to get teetime of matched golfcourse
                            ...
                            //end to get teetime of matched golfcourse
                         }
                     }
                     else
                     {
                    ...
                    $data['contents']=$this->load->view('specific_course_avail_listing',$results,true);
