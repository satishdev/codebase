...
class My_db_lib {
    ...
    private $table_rows=array(
        ...
        'player_education'=>array('id',  'players_id',  'educations_id',  'course_name',  'degree',  'major',  'from_date',  'to_date',  'country_id',  'state',  'zip',  'ip_address',  'created_date',  'modified_date'),
        'player_expierence'=>array('id',  'players_id',  'company',  'designation',  'location',  'additional_notes', 'exp_skill',  'from_date',  'to_date',  'till_now',  'country_id',  'state',  'zip',  'created_date',  'modified_date',  'ip_address'),
