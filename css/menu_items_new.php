...
<!--<form name="srch" id="srch" action="<?php  //echo $form_url;?>" method="post">-->
      <form name="srch" id="srch" action="<?=$form_url?>" method="post">
            ...
            <a class="menu_link">
			<input type="text" id="serchKey" placeholder="Search..." class="menu_search text" name="serchKey" onkeyup="auto_complete()" value="<?php if($this->session->userdata('pserchKey'))echo $this->session->userdata('pserchKey');else echo @$serchKey;?>"/>
