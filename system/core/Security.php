...
class CI_Security {
	 ...
	 * harvested from examining vulnerabilities in other programs http://ha.ckers.org/xss.html
	 *
	 ...
	 *
	 * It removes the evil attribute and either 	- Everything up until a space
	 *		For example, everything between the pipes		<a |style=document.write('hello');alert('world');| class=link>
